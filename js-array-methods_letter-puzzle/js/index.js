...
const employeeNamedFrederique = employees.some((employee) => employee.name == 'Frederique');
...
const employeesSortedByLastName = employees.toSorted((a, b) => b.lastName.localeCompare(a.lastName));
